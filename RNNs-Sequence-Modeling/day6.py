...
# For simplicity lets create a simple dataset
# English sentences
english_sentences = ["hello", "How are you", "Good Morning", "thank you", "good Night"]
french_sentences = ["bonjour", "comment sa va", "bom matin", "mercy", "bonne nuit"]

# Vocabulary and Tokenazation
...
# Define the Seq2Seq model component encoder and decoder
...
# Let's create the training function
def train(model, dataloader, optimizer, criterion, device, num_epochs=5):
    ...
    for epoch in range(num_epochs):
        ...
        print(f"Epoch: {epoch+1}/{num_epochs}, Loss: {epochs_loss / len(dataloader):.4f}")

train(model, dataloader, optimizer, criterion, device, num_epochs=20)
